...
int main ()
{
  ...
  {
    if(isdigit(c)){ push(top,c);}           // If the character is a digit push to the stack
...
void displayExplanation()
{
  cout << "\n\nThe purpose of this program is to test my ability to use the stack to evaluate a postfix expression\nafter reading it from a file then print the results to the screen.\n\n";
}
